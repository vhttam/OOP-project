...
public class NhanVien_QuanLiKho extends NhanVien {
	...
	public NhanVien_QuanLiKho (String chucvu, String id, String hoten, String gioitinh, String namsinh, int soNgayNghi, float luongThuong, String caLamViec,float phuCap) {
