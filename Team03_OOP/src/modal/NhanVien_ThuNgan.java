...
public class NhanVien_ThuNgan extends NhanVien implements TinhThuongDoanhThu {
	...
	public NhanVien_ThuNgan(String chucvu, String id, String hoten, String gioitinh, String namsinh,int soNgayNghi, float luongThuong, String caLamViec, float doanhThu) {
		super(id,hoten,gioitinh,namsinh,soNgayNghi,luongThuong,caLamViec);
		this.doanhThu = doanhThu;
		super.setchucvu("Thu Ngan");
	}
	public NhanVien_ThuNgan() {
		super.setchucvu("Thua Ngan");
	}
